// ----------------------------------------------------------------------------
// nexus | Next100fibersFieldCage.h
//
...
namespace nexus {
  ...
  class Next100fibersFieldCage: public GeometryBase
  {
  public:
    Next100fibersFieldCage(G4double grid_thickn);
    ~Next100fibersFieldCage();
  ...
  inline void Next100fibersFieldCage::SetELtoSapphireWDWdistance(G4double distance){
    gate_sapphire_wdw_dist_ = distance;
  }

  inline void Next100fibersFieldCage::SetSiPMPitch(G4double pitch) {
    sipm_pitch_ = pitch;
  }
