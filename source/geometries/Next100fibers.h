...
namespace nexus {
  ...
  class Next100fibersShielding;
  class Next100fibersVessel;
  class Next100fibersIcs;
  class Next100fibersInnerElements;
  class LSCHallA;

  class Next100fibers: public GeometryBase
  {
  public:
    /// Constructor
    Next100fibers();
  ...
  private:
    ...
    Next100fibersShielding* shielding_;
    Next100fibersVessel*    vessel_;
    Next100fibersIcs*       ics_;
    Next100fibersInnerElements* inner_elements_;
