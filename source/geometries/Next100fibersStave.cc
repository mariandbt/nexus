...
Next100fibersStave::Next100fibersStave(G4double ring_drift_buffer_dist,
...
Next100fibersStave::~Next100fibersStave()
{
}

void Next100fibersStave::Construct()
{
