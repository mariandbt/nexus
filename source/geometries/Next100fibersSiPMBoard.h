// -----------------------------------------------------------------------------
// nexus | Next100fibersSiPMBoard.h
//
...
namespace nexus {
  ...
  class Next100fibersSiPM;

  // Geometry of the 8x8 SiPM boards used in the tracking plane of NEXT-100

  class Next100fibersSiPMBoard: public GeometryBase
  {
  public:
    // Default constructor
    Next100fibersSiPMBoard();
    // Destructor
    ~Next100fibersSiPMBoard();
    //
  ...
  private:
    ...
    Next100fibersSiPM* sipm_;
  };

  inline void Next100fibersSiPMBoard::SetMotherPhysicalVolume(G4VPhysicalVolume* p)
  { mpv_ = p;}

  inline G4double Next100fibersSiPMBoard::GetSize() const
  { return size_; }

  inline G4double Next100fibersSiPMBoard::GetThickness() const
  { return (board_thickness_ + mask_thickness_); }

  inline const std::vector<G4ThreeVector>& Next100fibersSiPMBoard::GetSiPMPositions() const
  { return sipm_positions_; }

  inline G4double Next100fibersSiPMBoard::GetSiPMPitch() const
  { return pitch_; }
