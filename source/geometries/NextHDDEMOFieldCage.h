...
#ifndef NEXTHDDEMO_FIELDCAGE_H
#define NEXTHDDEMO_FIELDCAGE_H
...
namespace nexus {
  ...
  class NextHDDEMOFieldCage: public GeometryBase
  {
  public:
    NextHDDEMOFieldCage();
    ~NextHDDEMOFieldCage();
  ...
  inline void NextHDDEMOFieldCage::SetELtoSapphireWDWdistance(G4double distance){
