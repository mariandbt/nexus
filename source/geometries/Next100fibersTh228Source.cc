// ----------------------------------------------------------------------------
// nexus | Next100fibersTh228Source.cc
//
...
namespace nexus {
  ...
  Next100fibersTh228Source::Next100fibersTh228Source(): GeometryBase(),
                                            source_diam_ (1. * mm),
  ...
  Next100fibersTh228Source::~Next100fibersTh228Source()
  {
  }

  void Next100fibersTh228Source::Construct()
  {
  ...
  G4double Next100fibersTh228Source::GetSupportLength() const
  {
    return support_length_;
  }

  G4double Next100fibersTh228Source::GetDiffThZPosEnd() const
  {
    return  source_diam_/2. + source_offset_;
  }

  G4double Next100fibersTh228Source::GetThRadius() const
  {
