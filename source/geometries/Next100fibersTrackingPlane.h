// ----------------------------------------------------------------------------
// nexus | Next100fibersTrackingPlane.h
//
...
namespace nexus {
  ...
  class Next100fibersSiPMBoard;
  class CylinderPointSampler;
  class BoxPointSampler;

  // Geometry of the tracking plane of the NEXT-100 detector

  class Next100fibersTrackingPlane: public GeometryBase
  {
  public:
    // Constructor
    Next100fibersTrackingPlane();
    // Destructor
    ~Next100fibersTrackingPlane();
    //
  ...
  private:
    ...
    Next100fibersSiPMBoard* sipm_board_geom_;
  ...
  inline void Next100fibersTrackingPlane::SetMotherPhysicalVolume(G4VPhysicalVolume* p)
  { mpv_ = p; }

  inline void Next100fibersTrackingPlane::SetELtoTPdistance(G4double distance){
