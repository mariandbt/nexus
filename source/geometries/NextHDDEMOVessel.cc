...
namespace nexus {
  ...
  NextHDDEMOVessel::NextHDDEMOVessel():
    GeometryBase(),
    ...
    xe_perc_(100.)
  {
    ...
    /// Messenger
    msg_ = new G4GenericMessenger(this, "/Geometry/NextHDDEMO/", "Control commands of geometry NextHDDEMO.");
  ...
  void NextHDDEMOVessel::Construct()
  {
    G4cout << "[NextHDDEMOVessel] Constructor called" << G4endl;
    // Body solid
  ...
  G4LogicalVolume* NextHDDEMOVessel::GetInternalLogicalVolume()
  {
    return internal_logic_vol_;
  }


  G4VPhysicalVolume* NextHDDEMOVessel::GetInternalPhysicalVolume()
  {
    return internal_phys_vol_;
  }


  G4ThreeVector NextHDDEMOVessel::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "VESSEL") {
      ...
      G4Exception("[NextHDDEMOVessel]", "GenerateVertex()", FatalException,
  ...
  G4double* NextHDDEMOVessel::GetPortZpositions(){
    static G4double port_positions[]{port_z_1a_, port_z_2a_, port_z_1b_, port_z_2b_};
    return port_positions;
  }

  G4double NextHDDEMOVessel::GetInnerRadius(){
    return vessel_in_rad_;
  }

  G4double NextHDDEMOVessel::GetLength(){
    return body_length_;
  }
