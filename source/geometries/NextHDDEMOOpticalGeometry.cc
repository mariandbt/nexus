// ----------------------------------------------------------------------------
// nexus | NextHDDEMOOpticalGeometry.cc
//
...
#include "NextHDDEMOOpticalGeometry.h"
...
namespace nexus {
  ...
  REGISTER_CLASS(NextHDDEMOOpticalGeometry, GeometryBase)

  NextHDDEMOOpticalGeometry::NextHDDEMOOpticalGeometry(): GeometryBase(),
  ...
  void NextHDDEMOOpticalGeometry::Construct()
  {
    G4cout << "[NextHDDEMOOpticalGeometry] Constructor called" << G4endl;
  ...
  NextHDDEMOOpticalGeometry::~NextHDDEMOOpticalGeometry()
  {

  }


  G4ThreeVector NextHDDEMOOpticalGeometry::GenerateVertex(const G4String& region) const
  {
