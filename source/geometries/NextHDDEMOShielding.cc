...
namespace nexus {
  ...
  NextHDDEMOShielding::NextHDDEMOShielding():
    GeometryBase{},
  ...
  void NextHDDEMOShielding::Construct()
  {
    G4cout << "[NextHDDEMOShielding] Constructor called" << G4endl;
    // LEAD BOX   ///////////
  ...
  G4LogicalVolume* NextHDDEMOShielding::GetAirLogicalVolume() const
  {
    return air_box_logic_;
  }

  G4ThreeVector NextHDDEMOShielding::GetDimensions() const
  {
    return G4ThreeVector(lead_x_, lead_y_, lead_z_);
  }

  G4ThreeVector NextHDDEMOShielding::GetAirDisplacement() const
  {
    return G4ThreeVector(0., -(steel_thickness_ + beam_thickness_2)/2., 0.);
  }

  G4ThreeVector NextHDDEMOShielding::GenerateVertex(const G4String& region) const
  {
    ...
    // generators. They are placed in INNER_AIR volume.
      ...
      G4Exception("[NextHDDEMOShielding]", "GenerateVertex()", FatalException,
