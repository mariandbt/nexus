...
namespace nexus {
  ...
  class Next100fibersVessel: public GeometryBase
  {
  public:
    /// Constructor
    Next100fibersVessel(G4double ics_ep_lip_width);
  ...
  inline void Next100fibersVessel::SetELtoTPdistance(G4double distance){
    gate_tp_distance_ = distance;
  }

  inline void Next100fibersVessel::SetGateZpos(G4double pos){
    gate_z_pos_ = pos;
  }

  inline G4double Next100fibersVessel::GetGateZpos(){
    return gate_z_pos_;
  }
