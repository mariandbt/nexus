...
#include "Next100fibersVessel.h"
#include "MaterialsList.h"
#include "Visibilities.h"
#include "OpticalMaterialProperties.h"
#include "CylinderPointSampler.h"
#include "SpherePointSampler.h"
#include "Next100fibersTh228Source.h"
...
namespace nexus {
  ...
  Next100fibersVessel::Next100fibersVessel(G4double ics_ep_lip_width):
    GeometryBase(),
    ...
    dist_th_zpos_end_(0.*mm)
  {
    ...
    /// Messenger
    msg_ =
      new G4GenericMessenger(this, "/Geometry/Next100fibers/", "Control commands of Next100fibers geometry.");
  ...
  void Next100fibersVessel::Construct()
  {
    // Body solid
    ...
    if (gas_ == "naturalXe") {
      ...
      G4Exception("[Next100fibersVessel]", "Construct()", FatalException,
    ...
    if (th_source_ != "no_source") {
      ...
      if (th_source_ == "new_source") {
        Next100fibersTh228Source source = Next100fibersTh228Source();
        source.Construct();
  ...
  Next100fibersVessel::~Next100fibersVessel()
  {
    delete body_gen_;
  ...
  G4LogicalVolume* Next100fibersVessel::GetInternalLogicalVolume()
  {
    return internal_logic_vol_;
  }


  G4VPhysicalVolume* Next100fibersVessel::GetInternalPhysicalVolume()
  {
    return internal_phys_vol_;
  }


  G4ThreeVector Next100fibersVessel::GenerateVertex(const G4String& region) const
  {
    ...
    if (region == "VESSEL") {
      ...
      G4Exception("[Next100fibersVessel]", "GenerateVertex()", FatalException,
  ...
  G4double* Next100fibersVessel::GetPortZpositions(){
