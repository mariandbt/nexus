// ----------------------------------------------------------------------------
// nexus | NextHDDEMOIcs.cc
//
// Inner copper shielding of the NextHDDEMO detector.
//
...
namespace nexus {
  ...
  void NextHDDEMOIcs::SetLogicalVolume(G4LogicalVolume* mother_logic)
  {
    mother_logic_ = mother_logic;
  }


  void NextHDDEMOIcs::Construct()
  {
    G4cout << "[NextHDDEMOIcs] Constructor called" << G4endl;
  ...
  G4ThreeVector NextHDDEMOIcs::GenerateVertex(const G4String& region) const
  {
  ...
  void NextHDDEMOIcs::SetPortZpositions(G4double port_positions[])
  {
