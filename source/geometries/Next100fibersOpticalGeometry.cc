// ----------------------------------------------------------------------------
// nexus | Next100fibersOpticalGeometry.cc
//
...
#include "Next100fibersOpticalGeometry.h"
...
namespace nexus {
  ...
  REGISTER_CLASS(Next100fibersOpticalGeometry, GeometryBase)

  Next100fibersOpticalGeometry::Next100fibersOpticalGeometry():
    GeometryBase(),
  ...
  void Next100fibersOpticalGeometry::Construct()
  {
    // LAB /////////////////////////////////////////////////////////////
  ...
  if (gas_ == "naturalXe") {
    ...
    G4Exception("[Next100fibersOpticalGeometry]", "Construct()", FatalException,
  ...
  G4ThreeVector Next100fibersOpticalGeometry::GenerateVertex(const G4String& region) const
  {
