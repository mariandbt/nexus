...
#ifndef NEXTHDDEMO_VESSEL_H
#define NEXTHDDEMO_VESSEL_H
...
namespace nexus {
  ...
  class NextHDDEMOVessel: public GeometryBase
  {
  public:
    /// Constructor
    NextHDDEMOVessel();
    ...
    G4double GetInnerRadius(); // get vessel inner radius
    G4double GetLength(); // get vessel length
  ...
  inline void NextHDDEMOVessel::SetELtoTPdistance(G4double distance){
