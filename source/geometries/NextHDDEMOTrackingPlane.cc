// ----------------------------------------------------------------------------
// nexus | NextHDDEMOTrackingPlane.cc
//
...
void NextHDDEMOTrackingPlane::Construct()
{
  G4cout << "[NextHDDEMOTrackingPlane] Constructor called" << G4endl;
  // Make sure the pointer to the mother volume is actually defined
  if (!mpv_)
    G4Exception("[NextHDDEMOTrackingPlane]", "Construct()",
...
void NextHDDEMOTrackingPlane::PlaceSiPMBoardColumns(G4int num_boards,
...
void NextHDDEMOTrackingPlane::PrintSiPMPositions() const
{
...
G4ThreeVector NextHDDEMOTrackingPlane::GenerateVertex(const G4String& region) const
{
