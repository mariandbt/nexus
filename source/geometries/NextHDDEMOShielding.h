...
#ifndef NEXTHDDEMO_SHIELDING_H
#define NEXTHDDEMO_SHIELDING_H
...
namespace nexus {
  ...
  class NextHDDEMOShielding: public GeometryBase
  {
  public:
    /// Constructor
    NextHDDEMOShielding();
  ...
  inline G4double NextHDDEMOShielding::GetHeight() const
  { return lead_y_; }
