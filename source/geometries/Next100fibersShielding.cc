// ----------------------------------------------------------------------------
// nexus | Next100fibersShielding.cc
//
...
namespace nexus {
  ...
  Next100fibersShielding::Next100fibersShielding():
    GeometryBase{},
  ...
  void Next100fibersShielding::Construct()
  {
  ...
  G4LogicalVolume* Next100fibersShielding::GetAirLogicalVolume() const
  {
    return air_box_logic_;
  }

  G4ThreeVector Next100fibersShielding::GetDimensions() const
  {
    return G4ThreeVector(lead_x_, lead_y_, lead_z_);
  }

  G4ThreeVector Next100fibersShielding::GetAirDisplacement() const
  {
    return G4ThreeVector(0., -(steel_thickn_ + beam_thickn_2_)/2., 0.);
  }

  G4ThreeVector Next100fibersShielding::GenerateVertex(const G4String& region) const
  {
    ...
    // only their generators. They are placed in INNER_AIR volume.
      ...
      G4Exception("[Next100fibersShielding]", "GenerateVertex()", FatalException,
  ...
  G4ThreeVector Next100fibersShielding::ProjectToRegion(const G4String& region,
						  ...
						  const G4ThreeVector& dir) const
  {
    ...
    if (region == "EXTERNAL"){
      ...
      G4Exception("[Next100fibersShielding]", "ProjectToRegion()", FatalException,
		  "Unknown vertex generation region!");
    }
