// ----------------------------------------------------------------------------
// nexus | Next100fibersFieldCage.cc
//
...
Next100fibersFieldCage::Next100fibersFieldCage(G4double grid_thickn):
  GeometryBase(),
  // Dimensions
...
void Next100fibersFieldCage::SetMotherLogicalVolume(G4LogicalVolume* mother_logic)
{
  mother_logic_ = mother_logic;
}


void Next100fibersFieldCage::SetMotherPhysicalVolume(G4VPhysicalVolume* mother_phys)
{
  mother_phys_ = mother_phys;
}


void Next100fibersFieldCage::Construct()
{
...
void Next100fibersFieldCage::DefineMaterials()
{
...
void Next100fibersFieldCage::BuildActive()
{
...
void Next100fibersFieldCage::BuildCathode()
{
...
void Next100fibersFieldCage::BuildBuffer()
{
...
void Next100fibersFieldCage::BuildELRegion()
{
  /// GATE ring.
  G4Tubs* gate_solid;
  ...
  if (el_gap_slice_min_ > el_gap_slice_max_)
    G4Exception("[Next100fibersFieldCage]", "Next100fibersFieldCage()",
...
void Next100fibersFieldCage::BuildLightTube()
{
  /// DRIFT PART ///
  /// Position of z planes
...
void Next100fibersFieldCage::BuildFieldCage()
{
  // HDPE cylinder.
  ...
  // as the teflon buffer reflector, in the side of the EP.
  Next100fibersStave stave = Next100fibersStave(ring_drift_buffer_dist_, num_drift_rings_, num_buffer_rings_);
  stave.Construct();
...
Next100fibersFieldCage::~Next100fibersFieldCage()
{
  delete active_gen_;
  delete buffer_gen_;
  delete xenon_gen_;
...
G4ThreeVector Next100fibersFieldCage::GenerateVertex(const G4String& region) const
{
  ...
  if (region == "CENTER") {
    ...
    G4Exception("[Next100fibersFieldCage]", "GenerateVertex()", FatalException,
...
G4ThreeVector Next100fibersFieldCage::GetActivePosition() const
{
