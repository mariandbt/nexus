...
Next100fibersSiPM::Next100fibersSiPM():
  GeometryBase(),
  sensor_depth_       (-1),
  mother_depth_       (0),
  naming_order_       (0),
...
G4ThreeVector Next100fibersSiPM::GetDimensions() const
{
  return dimensions_;
}


void Next100fibersSiPM::Construct()
{
  // ENCASING //////////////////////////////////////////////
  ...
  if (!sdmgr->FindSensitiveDetector(sdname, false)) {
    ...
    if (sensor_depth_ == -1)
      G4Exception("[Next100fibersSiPM]", "Construct()", FatalException,
