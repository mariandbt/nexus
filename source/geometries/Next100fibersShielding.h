// ----------------------------------------------------------------------------
// nexus | Next100fibersShielding.h
//
...
namespace nexus {
  ...
  class Next100fibersShielding: public GeometryBase
  {
  public:
    /// Constructor
    Next100fibersShielding();
  ...
  inline G4double Next100fibersShielding::GetHeight() const
  { return lead_y_; }
