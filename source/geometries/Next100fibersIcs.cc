...
namespace nexus {
  ...
  Next100fibersIcs::Next100fibersIcs(G4double ics_ep_lip_width):
    GeometryBase(),
    in_rad_   (55.465 * cm),
    thickness_(12.0   * cm),
    ...
    visibility_ (0)
  {
    ...
    /// Messenger
    msg_ = new G4GenericMessenger(this, "/Geometry/Next100fibers/", "Control commands of geometry Next100fibers.");
    msg_->DeclareProperty("ics_vis", visibility_, "ICS Visibility");

  }

  void Next100fibersIcs::SetLogicalVolume(G4LogicalVolume* mother_logic)
  {
    mother_logic_ = mother_logic;
  }


  void Next100fibersIcs::Construct()
  {
  ...
  Next100fibersIcs::~Next100fibersIcs()
  {
    delete ics_gen_;
  }


  G4ThreeVector Next100fibersIcs::GenerateVertex(const G4String& region) const
  {
  ...
  void Next100fibersIcs::SetPortZpositions(G4double port_positions[])
  {
