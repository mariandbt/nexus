...
namespace nexus {
  ...
  class Next100fibersStave: public GeometryBase
  {
  public:
    Next100fibersStave(G4double ring_drift_buffer_dist_,
  ...
  inline G4double Next100fibersStave::GetHolderShortY() const {return holder_short_y_;};
  inline G4double Next100fibersStave::GetHolderLongY() const {return holder_long_y_;};
  inline G4double Next100fibersStave::GetCathodeLongY() const {return cathode_long_y_;};
  inline G4double Next100fibersStave::GetBufferLongLength() const {return buffer_long_length_;};
  inline G4double Next100fibersStave::GetCathodeOpening() const {return cathode_opening_;};
