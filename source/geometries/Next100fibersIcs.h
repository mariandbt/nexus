...
namespace nexus {
  ...
  class Next100fibersIcs: public GeometryBase
  {
  public:
    /// Constructor
    Next100fibersIcs(G4double ics_ep_lip_width);
  ...
  inline void Next100fibersIcs::SetELtoTPdistance(G4double distance){
    gate_tp_distance_ = distance;
  }

  inline void Next100fibersIcs::SetELtoSapphireWDWdistance(G4double distance){
